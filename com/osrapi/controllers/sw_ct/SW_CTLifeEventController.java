    ...
    public List<Resource<SW_CTLifeEventEntity>> save(
        ...
        if (entity.getModifiers() != null
          ...
          try {
            ...
            System.out.println("Cannot get embedded lookup Entity SW_CTEquipmentItemModifierEntity from Controller by name");
                    }
                    Field field = null;
          try {
            ...
            System.out.println("Cannot get embedded lookup Entity SW_CTEquipmentItemModifierEntity from class by name");
                    }
                    if (method != null
                            && field != null) {
            ...
            try {
              ...
              System.out.println("Cannot get embedded lookup Entity SW_CTEquipmentItemModifierEntity from Controller by code");
            }
            try {
              field = SW_CTEquipmentItemModifierEntity.class.getDeclaredField(
                  "code");
            } catch (NoSuchFieldException e) {
              System.out.println("Cannot get embedded lookup Entity SW_CTEquipmentItemModifierEntity from class by code");
            }
                        if (method != null
                                && field != null) {
                            field.setAccessible(true);
              ...
              System.out.println("CANNOT get embedded lookup Entity SW_CTEquipmentItemModifierEntity by name or code");
                }
                if (list != null
                        && !list.isEmpty()) {
    ...
    private void setIdFromRepository(final SW_CTLifeEventEntity entity) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Cannot get Entity SW_CTLifeEventEntity from Repository by name");
            }
            if (method != null
                    && field != null) {
                field.setAccessible(true);
            ...
            if (old == null
                ...
                try {
                    ...
                    // TODO Auto-generated catch block
          System.out.println("Cannot get Entity SW_CTLifeEventEntity from Repository by code");
                }
                if (method != null
                        && field != null) {
                    field.setAccessible(true);
            ...
            field = null;
                ...
                | IllegalAccessException
                | InvocationTargetException e) {
                System.out.println("Cannot get Entity SW_CTLifeEventEntity from Repository by name or code");
        }
        if (old != null
                && old.size() == 1) {
