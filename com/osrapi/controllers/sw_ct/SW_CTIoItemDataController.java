...
public class SW_CTIoItemDataController {
    ...
    if (entity.getTypes() != null
          ...
          try {
            ...
            System.out.println("Cannot get embedded lookup Entity SW_CTObjectTypeEntity from Controller by name");
                    }
                    Field field = null;
          try {
            ...
            System.out.println("Cannot get embedded lookup Entity SW_CTObjectTypeEntity from class by name");
                    }
                    if (method != null
                            && field != null) {
                        field.setAccessible(true);
            ...
            try {
              ...
              System.out.println("Cannot get embedded lookup Entity SW_CTObjectTypeEntity from Controller by code");
            }
            try {
              field = SW_CTObjectTypeEntity.class.getDeclaredField(
                  "code");
            } catch (NoSuchFieldException e) {
              System.out.println("Cannot get embedded lookup Entity SW_CTObjectTypeEntity from class by code");
            }
                        if (method != null
                                && field != null) {
                            field.setAccessible(true);
                    ...
                    field = null;
                        ...
                        | IllegalAccessException
                        | InvocationTargetException e) {
              System.out.println("CANNOT get embedded lookup Entity SW_CTObjectTypeEntity by name or code");
                }
                if (list != null
                        && !list.isEmpty()) {
    ...
    private void setIdFromRepository(final SW_CTIoItemDataEntity entity) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Cannot get Entity SW_CTIoItemDataEntity from Repository by name");
            }
            if (method != null
                    && field != null) {
                field.setAccessible(true);
            ...
            if (old == null
                ...
                try {
                    ...
                    // TODO Auto-generated catch block
          System.out.println("Cannot get Entity SW_CTIoItemDataEntity from Repository by code");
                }
                if (method != null
                        && field != null) {
                    field.setAccessible(true);
            ...
            field = null;
                ...
                | IllegalAccessException
                | InvocationTargetException e) {
                System.out.println("Cannot get Entity SW_CTIoItemDataEntity from Repository by name or code");
        }
        if (old != null
                && old.size() == 1) {
