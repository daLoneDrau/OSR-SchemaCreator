...
public class SW_CTIoPcDataController {
    ...
    if (entity.getLifeEvents() != null
            ...
            for (int i = entity.getLifeEvents().size() - 1; i >= 0; i--) {
                SW_CTLifeEventEntity lifeEvents = null;
                List<Resource<SW_CTLifeEventEntity>> list = null;
                try {
                    Method method = null;
          try {
            method = SW_CTLifeEventController.class.getDeclaredMethod(
                "getByName", new Class[] { String.class });
          } catch (NoSuchMethodException e) {
                        e.printStackTrace();
                    }
                    Field field = null;
          try {
            field = SW_CTLifeEventEntity.class
                .getDeclaredField("name");
          } catch (NoSuchFieldException e) {
                        e.printStackTrace();
                    }
                    if (method != null
                        ...
                        if (field.get(entity.getLifeEvents().get(i)) != null) {
                            list = (List<Resource<SW_CTLifeEventEntity>>) method
                                    .invoke(
                                            SW_CTLifeEventController.getInstance(),
            ...
            try {
              ...
              e.printStackTrace();
                ...
                if (lifeEvents == null) {
                    lifeEvents = (SW_CTLifeEventEntity) ((Resource) SW_CTLifeEventController
                            .getInstance()
