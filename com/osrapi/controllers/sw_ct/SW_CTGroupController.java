    ...
    private void setIdFromRepository(final SW_CTGroupEntity entity) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Cannot get Entity SW_CTGroupEntity from Repository by name");
            }
            if (method != null
                    && field != null) {
            ...
            if (old == null
                ...
                try {
                    ...
                    // TODO Auto-generated catch block
          System.out.println("Cannot get Entity SW_CTGroupEntity from Repository by code");
                }
                if (method != null
                        && field != null) {
                    field.setAccessible(true);
            ...
            field = null;
                ...
                System.out.println("Cannot get Entity SW_CTGroupEntity from Repository by name or code");
        }
        if (old != null
                && old.size() == 1) {
