        ...
        if (entity.getNodes() != null
            ...
            for (int i = entity.getNodes().size() - 1; i >= 0; i--) {
                ...
                try {
                    Method method = null;
          try {
            method = AVALONPathNodeController.class.getDeclaredMethod(
                "getByName", new Class[] { String.class });
          } catch (NoSuchMethodException e) {
            System.out.println("Cannot get embedded lookup Entity AVALONPathNodeEntity from Controller by name");
                    }
                    Field field = null;
          try {
            ...
            System.out.println("Cannot get embedded lookup Entity AVALONPathNodeEntity from class by name");
                    }
                    if (method != null
                            && field != null) {
                        ...
                        if (field.get(entity.getNodes().get(i)) != null) {
                            list = (List<Resource<AVALONPathNodeEntity>>) method
                                    .invoke(
                                            AVALONPathNodeController.getInstance(),
                                            (String) field.get(entity.getNodes().get(i)));
                        }
                    }
                    if (list == null) {
            try {
              ...
              System.out.println("Cannot get embedded lookup Entity AVALONPathNodeEntity from Controller by code");
            }
            try {
              field = AVALONPathNodeEntity.class.getDeclaredField(
                  "code");
            } catch (NoSuchFieldException e) {
              System.out.println("Cannot get embedded lookup Entity AVALONPathNodeEntity from class by code");
            }
                        if (method != null
                                && field != null) {
                            field.setAccessible(true);
              ...
              System.out.println("CANNOT get embedded lookup Entity AVALONPathNodeEntity by name or code");
                }
                if (list != null
                        && !list.isEmpty()) {
                ...
                if (nodes == null) {
                    nodes = (AVALONPathNodeEntity) ((Resource) AVALONPathNodeController
                            .getInstance()
                            .save(entity.getNodes().get(i)).get(0)).getContent();
                }
