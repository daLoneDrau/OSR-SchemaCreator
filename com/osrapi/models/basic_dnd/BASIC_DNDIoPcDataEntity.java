...
@Entity
@Table(name = "io_pc_data", schema = "basic_dnd")
public final class BASIC_DNDIoPcDataEntity {
    /**
  ...
  generator = "io_pc_data_seq")
    @SequenceGenerator(
        name = "io_pc_data_seq",
        sequenceName = "basic_dnd.io_pc_data_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link BASIC_DNDIoPcDataEntity}. */
    public BASIC_DNDIoPcDataEntity() {
        super();
    }
    /**
     * Gets the id.
    ...
    /** the gender. */
    @ManyToOne(targetEntity = BASIC_DNDGenderEntity.class, fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinColumn(name = "gender")
    @JsonProperty("gender")
  @NotNull
    private BASIC_DNDGenderEntity    gender;
    /**
     * Gets the gender.
     * @return {@link BASIC_DNDGenderEntity}
     */
    public BASIC_DNDGenderEntity getGender() {
        return gender;
    }
    /**
     * Sets the gender.
     * @param val the new value
     */
    public void setGender(final BASIC_DNDGenderEntity val) {
        gender = val;
    }
    ...
    @CollectionTable(name = "io_pc_data_name_lookup", schema = "basic_dnd",
  joinColumns = { @JoinColumn(name = "io_pc_data_id") })
    ...
    @Column
    @ElementCollection(targetClass = String.class)
    @CollectionTable(name = "io_pc_data_keyring_lookup", schema = "basic_dnd",
  joinColumns = { @JoinColumn(name = "io_pc_data_id") })
    ...
    @Fetch(FetchMode.SELECT)
    @JoinTable(name = "io_pc_data_groups_lookup", schema = "basic_dnd",
  joinColumns = @JoinColumn(name = "io_pc_data_id",
  ...
  referencedColumnName = "group_id"))
    ...
    @CollectionTable(name = "io_pc_data_equipped_items_lookup", schema = "basic_dnd",
  joinColumns = { @JoinColumn(name = "io_pc_data_id") })
  ...
  schema = "basic_dnd", joinColumns = @JoinColumn(name = "io_pc_data_id"))
