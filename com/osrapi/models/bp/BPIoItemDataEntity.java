...
@Entity
@Table(name = "io_item_data", schema = "bp")
public final class BPIoItemDataEntity {
    /**
  ...
  generator = "io_item_data_seq")
    @SequenceGenerator(
        ...
        sequenceName = "bp.io_item_data_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link BPIoItemDataEntity}. */
    public BPIoItemDataEntity() {
        super();
    }
    /**
     * Gets the id.
    ...
    /**
     * the list of {@link BPObjectTypeEntity}s associated with this
     * {@link BPIoItemDataEntity}.
     */
    @OneToMany(targetEntity = BPObjectTypeEntity.class,
      fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinTable(name = "io_item_data_types_lookup", schema = "bp",
  ...
  referencedColumnName = "object_type_id"))
    @JsonProperty("types")
    private List<BPObjectTypeEntity>    types;
    /**
     * Gets the list of types.
     * @return {@link List}<{@link BPObjectTypeEntity}>
     */
    public List<BPObjectTypeEntity> getTypes() {
        return types;
    }
    /**
     ...
     * @param val the new value
     */
    public void setTypes(final List<BPObjectTypeEntity> val) {
        types = val;
    }

    /**
     * the list of {@link BPGroupEntity}s associated with this
     * {@link BPIoItemDataEntity}.
     */
    @OneToMany(targetEntity = BPGroupEntity.class,
      fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinTable(name = "io_item_data_groups_lookup", schema = "bp",
  joinColumns = @JoinColumn(name = "io_item_data_id",
  referencedColumnName = "io_item_data_id"),
  inverseJoinColumns = @JoinColumn(name = "group_id",
  referencedColumnName = "group_id"))
    @JsonProperty("groups")
    private List<BPGroupEntity>    groups;
    /**
     * Gets the list of groupss.
     * @return {@link List}<{@link BPGroupEntity}>
     */
    public List<BPGroupEntity> getGroups() {
        return groups;
    }
    /**
     ...
     * @param val the new value
     */
    public void setGroups(final List<BPGroupEntity> val) {
        groups = val;
    }

    @ElementCollection
    @CollectionTable(name = "io_item_data_modifiers_lookup",
  schema = "bp", joinColumns = @JoinColumn(name = "io_item_data_id"))
