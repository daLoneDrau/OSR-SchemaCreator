...
@Entity
@Table(name = "gender", schema = "csr")
public final class CSRGenderEntity {
    /**
  ...
  generator = "gender_seq")
    @SequenceGenerator(
        name = "gender_seq",
        sequenceName = "csr.gender_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link CSRGenderEntity}. */
    public CSRGenderEntity() {
        super();
    }
    /**
     * Gets the id.
