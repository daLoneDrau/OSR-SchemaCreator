...
@Entity
@Table(name = "equipment_item_modifier", schema = "csr")
public final class CSREquipmentItemModifierEntity {
    /**
  ...
  generator = "equipment_item_modifier_seq")
    @SequenceGenerator(
        ...
        sequenceName = "csr.equipment_item_modifier_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link CSREquipmentItemModifierEntity}. */
    public CSREquipmentItemModifierEntity() {
        super();
    }
    /**
     * Gets the id.
