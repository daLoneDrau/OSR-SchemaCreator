...
@Entity
@Table(name = "equipment_item_modifier", schema = "crypts_things")
public final class CRYPTS_THINGSEquipmentItemModifierEntity {
    /**
  ...
  generator = "equipment_item_modifier_seq")
    @SequenceGenerator(
        ...
        sequenceName = "crypts_things.equipment_item_modifier_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link CRYPTS_THINGSEquipmentItemModifierEntity}. */
    public CRYPTS_THINGSEquipmentItemModifierEntity() {
        super();
    }
    /**
     * Gets the id.
