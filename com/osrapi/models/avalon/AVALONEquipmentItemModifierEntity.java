...
@Entity
@Table(name = "equipment_item_modifier", schema = "avalon")
public final class AVALONEquipmentItemModifierEntity {
    /**
  ...
  generator = "equipment_item_modifier_seq")
    @SequenceGenerator(
        ...
        sequenceName = "avalon.equipment_item_modifier_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link AVALONEquipmentItemModifierEntity}. */
    public AVALONEquipmentItemModifierEntity() {
        super();
    }
    /**
     * Gets the id.
