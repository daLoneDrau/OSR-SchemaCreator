...
@Entity
@Table(name = "room_bkup", schema = "ff")
public final class FFRoomBkupEntity {
    /**
     * the primary key - an autogenerated id (unique for each user in the db).
     */
    @Id
    @Column(name = "room_bkup_id")
    @GeneratedValue(strategy = GenerationType.SEQUENCE,
  generator = "room_bkup_seq")
    @SequenceGenerator(
        name = "room_bkup_seq",
        sequenceName = "ff.room_bkup_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link FFRoomBkupEntity}. */
    public FFRoomBkupEntity() {
        super();
    }
    /**
     * Gets the id.
  ...
  @NotNull
    ...
    @Fetch(FetchMode.SELECT)
    @JoinTable(name = "room_bkup_doors_lookup", schema = "ff",
  joinColumns = @JoinColumn(name = "room_bkup_id",
  referencedColumnName = "room_bkup_id"),
  ...
  referencedColumnName = "door_id"))
    ...
    @ElementCollection
    @CollectionTable(name = "room_bkup_scripted_events_lookup",
  schema = "ff", joinColumns = @JoinColumn(name = "room_bkup_id"))
    ...
    @ElementCollection
    @CollectionTable(name = "room_bkup_exits_lookup",
  schema = "ff", joinColumns = @JoinColumn(name = "room_bkup_id"))
    @MapKeyColumn(name = "key")
    @Column(name = "value")
    @JsonProperty("exits")
