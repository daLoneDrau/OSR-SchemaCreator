...
@Entity
@Table(name = "io_pc_data", schema = "sw_ct")
public final class SW_CTIoPcDataEntity {
    /**
  ...
  generator = "io_pc_data_seq")
    @SequenceGenerator(
        name = "io_pc_data_seq",
        sequenceName = "sw_ct.io_pc_data_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link SW_CTIoPcDataEntity}. */
    public SW_CTIoPcDataEntity() {
        super();
    }
    /**
     * Gets the id.
    ...
    /** the homeland. */
    @ManyToOne(targetEntity = SW_CTHomelandEntity.class, fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinColumn(name = "homeland")
    @JsonProperty("homeland")
  @NotNull
    private SW_CTHomelandEntity    homeland;
    /**
     * Gets the homeland.
     * @return {@link SW_CTHomelandEntity}
     */
    public SW_CTHomelandEntity getHomeland() {
        return homeland;
    }
    /**
     * Sets the homeland.
     * @param val the new value
     */
    public void setHomeland(final SW_CTHomelandEntity val) {
        homeland = val;
    }
    ...
    /** the gender. */
    @ManyToOne(targetEntity = SW_CTGenderEntity.class, fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinColumn(name = "gender")
    @JsonProperty("gender")
  @NotNull
    private SW_CTGenderEntity    gender;
    /**
     * Gets the gender.
     * @return {@link SW_CTGenderEntity}
     */
    public SW_CTGenderEntity getGender() {
        return gender;
    }
    /**
     * Sets the gender.
     * @param val the new value
     */
    public void setGender(final SW_CTGenderEntity val) {
        gender = val;
    }
    ...
    /** the background. */
    @ManyToOne(targetEntity = SW_CTBackgroundEntity.class, fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinColumn(name = "background")
    @JsonProperty("background")
  @NotNull
    private SW_CTBackgroundEntity    background;
    /**
     * Gets the background.
     * @return {@link SW_CTBackgroundEntity}
     */
    public SW_CTBackgroundEntity getBackground() {
        return background;
    }
    /**
     * Sets the background.
     * @param val the new value
     */
    public void setBackground(final SW_CTBackgroundEntity val) {
        background = val;
    }
    ...
    @CollectionTable(name = "io_pc_data_name_lookup", schema = "sw_ct",
  joinColumns = { @JoinColumn(name = "io_pc_data_id") })
    ...
    @Column
    @ElementCollection(targetClass = String.class)
    @CollectionTable(name = "io_pc_data_keyring_lookup", schema = "sw_ct",
  joinColumns = { @JoinColumn(name = "io_pc_data_id") })
    ...
    /**
     * the list of {@link SW_CTGroupEntity}s associated with this
     * {@link SW_CTIoPcDataEntity}.
     */
    @OneToMany(targetEntity = SW_CTGroupEntity.class,
      fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinTable(name = "io_pc_data_groups_lookup", schema = "sw_ct",
  joinColumns = @JoinColumn(name = "io_pc_data_id",
  referencedColumnName = "io_pc_data_id"),
  inverseJoinColumns = @JoinColumn(name = "group_id",
  referencedColumnName = "group_id"))
    @JsonProperty("groups")
    private List<SW_CTGroupEntity>    groups;
    /**
     * Gets the list of groupss.
     * @return {@link List}<{@link SW_CTGroupEntity}>
     */
    public List<SW_CTGroupEntity> getGroups() {
        return groups;
    }
    /**
     ...
     * @param val the new value
     */
    public void setGroups(final List<SW_CTGroupEntity> val) {
        groups = val;
    }
    ...
    @CollectionTable(name = "io_pc_data_equipped_items_lookup", schema = "sw_ct",
  joinColumns = { @JoinColumn(name = "io_pc_data_id") })
  ...
  schema = "sw_ct", joinColumns = @JoinColumn(name = "io_pc_data_id"))
