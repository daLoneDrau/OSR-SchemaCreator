...
public final class SW_CTIoPcDataEntity {
  ...
  joinColumns = { @JoinColumn(name = "io_pc_data_id") })
    ...
    /**
     * the list of {@link SW_CTLifeEventEntity}s associated with this
     * {@link SW_CTIoPcDataEntity}.
     */
    @OneToMany(targetEntity = SW_CTLifeEventEntity.class,
      fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinTable(name = "io_pc_data_life_events_lookup", schema = "sw_ct",
  joinColumns = @JoinColumn(name = "io_pc_data_id",
  ...
  referencedColumnName = "life_event_id"))
    ...
    private List<SW_CTLifeEventEntity>    lifeEvents;
    /**
     * Gets the list of lifeEventss.
     * @return {@link List}<{@link SW_CTLifeEventEntity}>
     */
    public List<SW_CTLifeEventEntity> getLifeEvents() {
        return lifeEvents;
    }
    /**
     ...
     * @param val the new value
     */
    public void setLifeEvents(final List<SW_CTLifeEventEntity> val) {
        lifeEvents = val;
    }
