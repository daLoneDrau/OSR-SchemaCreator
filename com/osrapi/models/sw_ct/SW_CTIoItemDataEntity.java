...
@Entity
@Table(name = "io_item_data", schema = "sw_ct")
public final class SW_CTIoItemDataEntity {
    /**
  ...
  generator = "io_item_data_seq")
    @SequenceGenerator(
        ...
        sequenceName = "sw_ct.io_item_data_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link SW_CTIoItemDataEntity}. */
    public SW_CTIoItemDataEntity() {
        super();
    }
    /**
     * Gets the id.
    ...
    /** the damages. */
    @ManyToOne(targetEntity = SW_CTDiceEntity.class, fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinColumn(name = "damages")
    @JsonProperty("dice")
  
    private SW_CTDiceEntity    damages;
    /**
     * Gets the damages.
     * @return {@link SW_CTDiceEntity}
     */
    public SW_CTDiceEntity getDamages() {
        return damages;
    }
    /**
     * Sets the damages.
     * @param val the new value
     */
    public void setDamages(final SW_CTDiceEntity val) {
        damages = val;
    }
    ...
    /**
     * the list of {@link SW_CTObjectTypeEntity}s associated with this
     * {@link SW_CTIoItemDataEntity}.
     */
    @OneToMany(targetEntity = SW_CTObjectTypeEntity.class,
      fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinTable(name = "io_item_data_types_lookup", schema = "sw_ct",
  ...
  referencedColumnName = "object_type_id"))
    @JsonProperty("types")
    private List<SW_CTObjectTypeEntity>    types;
    /**
     * Gets the list of types.
     * @return {@link List}<{@link SW_CTObjectTypeEntity}>
     */
    public List<SW_CTObjectTypeEntity> getTypes() {
        return types;
    }
    /**
     ...
     * @param val the new value
     */
    public void setTypes(final List<SW_CTObjectTypeEntity> val) {
        types = val;
    }
    ...
    @OneToMany(targetEntity = SW_CTGroupEntity.class,
      fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinTable(name = "io_item_data_groups_lookup", schema = "sw_ct",
  joinColumns = @JoinColumn(name = "io_item_data_id",
  referencedColumnName = "io_item_data_id"),
  ...
  schema = "sw_ct", joinColumns = @JoinColumn(name = "io_item_data_id"))
