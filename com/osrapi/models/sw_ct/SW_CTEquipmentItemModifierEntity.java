...
@Entity
@Table(name = "equipment_item_modifier", schema = "sw_ct")
public final class SW_CTEquipmentItemModifierEntity {
    /**
  ...
  generator = "equipment_item_modifier_seq")
    @SequenceGenerator(
        ...
        sequenceName = "sw_ct.equipment_item_modifier_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link SW_CTEquipmentItemModifierEntity}. */
    public SW_CTEquipmentItemModifierEntity() {
        super();
    }
    /**
     * Gets the id.
