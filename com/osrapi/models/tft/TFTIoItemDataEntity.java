...
@Entity
@Table(name = "io_item_data", schema = "tft")
public final class TFTIoItemDataEntity {
    /**
  ...
  generator = "io_item_data_seq")
    @SequenceGenerator(
        ...
        sequenceName = "tft.io_item_data_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link TFTIoItemDataEntity}. */
    public TFTIoItemDataEntity() {
        super();
    }
    /**
     * Gets the id.
    ...
    /** the stRequirement. */
    @Column(name = "st_requirement")
    @JsonProperty("st_requirement")
    @NotNull
    private long                    stRequirement;
    /**
     * Gets the stRequirement.
     * @return {@link long}
     */
    public long getStRequirement() {
        return stRequirement;
    }
    /**
     * Sets the stRequirement.
     * @param val the new value
     */
    public void setStRequirement(final long val) {
        stRequirement = val;
    }

    /**
     * the list of {@link TFTObjectTypeEntity}s associated with this
     * {@link TFTIoItemDataEntity}.
     */
    @OneToMany(targetEntity = TFTObjectTypeEntity.class,
      fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinTable(name = "io_item_data_types_lookup", schema = "tft",
  ...
  referencedColumnName = "object_type_id"))
    @JsonProperty("types")
    private List<TFTObjectTypeEntity>    types;
    /**
     * Gets the list of types.
     * @return {@link List}<{@link TFTObjectTypeEntity}>
     */
    public List<TFTObjectTypeEntity> getTypes() {
        return types;
    }
    /**
     ...
     * @param val the new value
     */
    public void setTypes(final List<TFTObjectTypeEntity> val) {
        types = val;
    }
    ...
    @OneToMany(targetEntity = TFTGroupEntity.class,
      fetch = FetchType.EAGER)
    @Fetch(FetchMode.SELECT)
    @JoinTable(name = "io_item_data_groups_lookup", schema = "tft",
  joinColumns = @JoinColumn(name = "io_item_data_id",
  referencedColumnName = "io_item_data_id"),
  ...
  schema = "tft", joinColumns = @JoinColumn(name = "io_item_data_id"))
