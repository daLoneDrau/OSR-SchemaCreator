...
@Entity
@Table(name = "equipment_item_modifier", schema = "tft")
public final class TFTEquipmentItemModifierEntity {
    /**
  ...
  generator = "equipment_item_modifier_seq")
    @SequenceGenerator(
        ...
        sequenceName = "tft.equipment_item_modifier_id_seq",
        allocationSize = 1
    )
    private Long                    id;
    /** Creates a new instance of {@link TFTEquipmentItemModifierEntity}. */
    public TFTEquipmentItemModifierEntity() {
        super();
    }
    /**
     * Gets the id.
