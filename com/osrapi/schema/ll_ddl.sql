...
(
  ...
  module text,
  morale smallint,
  move_per_round smallint,
  move_per_turn smallint,
  name character varying(50) NOT NULL,
  number_appearing smallint,
  number_appearing_in_lair smallint,
  npc_flags bigint,
  saving_throw text,
  title character varying(50) NOT NULL,
  weapon text,
  ...
  CONSTRAINT io_npc_data_damages_fk FOREIGN KEY (damages)
    REFERENCES ll.dice (dice_id) MATCH SIMPLE
    ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT io_npc_data_gender_fk FOREIGN KEY (gender)
    REFERENCES ll.gender (gender_id) MATCH SIMPLE
    ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT io_npc_data_number_appearing_fk FOREIGN KEY (number_appearing)
    REFERENCES ll.dice (dice_id) MATCH SIMPLE
    ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT io_npc_data_number_appearing_in_lair_fk FOREIGN KEY (number_appearing_in_lair)
    REFERENCES ll.dice (dice_id) MATCH SIMPLE
    ON UPDATE NO ACTION ON DELETE NO ACTION,
