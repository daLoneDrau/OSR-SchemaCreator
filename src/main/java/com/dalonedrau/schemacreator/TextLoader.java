...
public final class TextLoader {
    ...
    public String loadText(final String fileName)
        ...
        if (true) {
            ...
            /*
             * FileHandle file = Gdx.files.internal(sb.toString()); final int
             * defaultCharBufferSize = 8192; input =
             * file.reader(defaultCharBufferSize);
             */
        }
        sb.setLength(0);
    ...
    public String loadText(final String fileName, final String section)
        ...
        try {
            ...
            if (true) {
                ...
                /*
                 * FileHandle file = Gdx.files.internal(sb.toString()); final
                 * int defaultCharBufferSize = 8192; input =
                 * file.reader(defaultCharBufferSize);
                 */
            }
            sb.setLength(0);
