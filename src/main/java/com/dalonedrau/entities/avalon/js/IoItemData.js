  [{
  	...
  	"weapon_length": 4,
  	"price": 6,
  	"internal_script": "ThrustingSword",
  	"types": [{
  		"code": "OBJECT_TYPE_WEAPON"
  	}, {
  		"code": "OBJECT_TYPE_1H"
  	...
  	"name": "Tremendous Armor",
  	"title": "Tremendous Armor",
  	"weight_class": {
  		"code": "T"
  	},
  	"protections": [{
