...
public class Room {
	...
	@MapForeignKey(keyColumnType = "character varying(5)", keyField = "code", keyTargetClass = "Direction", valueColumn = "value", valueColumnType = "character varying(3)", valueField = "code", valueTargetClass = "Room")
