  [{
  	...
  	"name": "table_titled",
  	"text": "<table><title><genText></title><genText></table>"
  }, {
  	"name": "table_untitled",
  	"text": "<table><genText></table>"
  }, {
  	"name": "menu_table",
  	"text": "<table><title><genText></title><genText>\n<genText></table>\n<genText>"
  }, {
  	"name": "stats_table",
  	"text": "Skill  : <genText>\nStamina: <genText>\nLuck   : <genText>"
  }, {
  	...
  	"name": "invalid_input",
  	"text": "I'm sorry, I can't understand what you were trying to do."
  }, {
  	"name": "invalid_exit",
  	...
  	"name": "1",
  	"text": "You peer into the gloom to see dark, slimy walls with pools of water on the stone floor in front of you. The air is cold and dank. You light your lantern and step warily into the blackness. Cobwebs brush your face and you hear the scurrying of tiny feet: rats, most likely. You set off into the cave. After a few yards you arrive at a junction. Passages lead West and East."
  }, {
  	"name": "1_EAST",
  	"text": "You take the eastern passage."
  }, {
  	"name": "1_WEST",
  	"text": "You follow the passage leading west."
  }, {
  	"name": "1_SOUTH",
  	"text": "You would abandon your adventure?!  Shame.  SHAME!  I won't allow it.  Close the tab if you want to leave so bad."
  }, {
  	"name": "1_SECONDARY",
  	...
  	"text": "The orc eyes you defiantly. '~mugh... tum brakat~'"
  }, {
  	"name": "orc_sentry_ouch_strong",
  	"text": "The orc screams at you in desperation. '~MUGH AGDUM~'"
  }, {
  	"name": "orc_sentry_search",
  	"text": "'~tugh gimbat~'.  The orc scans the room."
  }, {
  	"name": "orc_sentry_thief",
  	"text": "'~gulBIL~'"
  }, {
